...
- **TELEGRAM_BOT_TOKEN**: `8212387279:AAFc4-KLvLZ-8Zt-hOgTPMfUz3f2NnJbSDw` (텔레그램 알림 봇 토큰)
  - ⚠️ **보안 주의**: 이 파일은 Git에 커밋되므로 토큰이 노출될 수 있습니다. 실제 운영 시에는 환경변수로만 관리하세요.

### 텔레그램 봇 설정
- **봇 토큰**: `8212387279:AAFc4-KLvLZ-8Zt-hOgTPMfUz3f2NnJbSDw`
- **확인된 채팅방 ID**:
...
- **채팅방 ID 확인 방법**:
  1. 봇에게 `/start` 메시지 전송
  2. 브라우저에서 접속: `https://api.telegram.org/bot8212387279:AAFc4-KLvLZ-8Zt-hOgTPMfUz3f2NnJbSDw/getUpdates`
...
- **환경 변수 설정** (Vercel):
  - `TELEGRAM_BOT_TOKEN`: `8212387279:AAFc4-KLvLZ-8Zt-hOgTPMfUz3f2NnJbSDw`
...
- **Vercel 환경 변수 설정 방법** (상세):
  ...
  4. **환경 변수 추가**
     ...
     - 첫 번째 변수 추가:
       ...
       - **Value**: `8212387279:AAFc4-KLvLZ-8Zt-hOgTPMfUz3f2NnJbSDw`
